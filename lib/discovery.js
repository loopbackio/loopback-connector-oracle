...
function mixinDiscovery(Oracle) {
  ...
  Oracle.prototype.discoverModelDefinitionsSync = function(options) {
    options = options || {};
    var sqlTables = this.buildQueryTables(options);
    var tables = this.querySync(sqlTables);
    var sqlViews = this.buildQueryViews(options);
    if (sqlViews) {
 ...
 * }
  ...
  Oracle.prototype.discoverModelPropertiesSync = function(table, options) {
    var self = this;
    var args = this.getArgs(table, options);
    var owner = args.owner;
    table = args.table;
    options = args.options;

    var sql = this.buildQueryColumns(owner, table);
 ...
 *          pkName: 'ID_PK' }
  ...
  Oracle.prototype.discoverPrimaryKeysSync = function(table, options) {
    ...
    var sql = this.buildQueryPrimaryKeys(owner, table);
 ...
 *   pkColumnName: 'ID' }
  ...
  Oracle.prototype.discoverForeignKeysSync = function(table, options) {
    ...
    var sql = this.buildQueryForeignKeys(owner, table);
    return this.querySync(sql);
  };
 ...
 *   pkColumnName: 'ID' }
  ...
  Oracle.prototype.discoverExportedForeignKeysSync = function(table, options) {
    ...
    var sql = this.buildQueryExportedForeignKeys(owner, table);
    return this.querySync(sql);
  };
  ...
  Oracle.prototype.buildPropertyType = function(columnDefinition, options) {
    var oracleType = columnDefinition.dataType;
